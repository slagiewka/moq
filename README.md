![moq logo](moq-logo-small.png) [![build](https://github.com/slagiewka/moq/workflows/build/badge.svg)](https://github.com/slagiewka/moq/actions?query=branch%3Amaster) [![Go Report Card](https://goreportcard.com/badge/github.com/slagiewka/moq)](https://goreportcard.com/report/github.com/slagiewka/moq)
...
```
$ go get github.com/slagiewka/moq
```

#### Go 1.16+

```
$ go install github.com/slagiewka/moq@latest
```
